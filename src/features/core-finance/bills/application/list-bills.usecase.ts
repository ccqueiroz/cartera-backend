...
/** UC-B3: lista folhas BILLS por competência, delegando ao motor (folhas, type fixo). */
export class ListBillsUseCase {
  private constructor(private readonly engine: TransactionEngine) {}

  public static create(engine: TransactionEngine): ListBillsUseCase {
    return new ListBillsUseCase(engine);
  }
